...
public class Mail {
	...
	public static MimeMessage createMimeMessage(Session session, String sender, 
		...
		try {
			...
			message.setSubject("密码修改通知邮件", "utf-8");//邮件主题
			...
			//邮件主体内容
			textPart.setContent("亲爱的"+username+"你好，您刚刚在-有座书城-网站修改了密码！如果是本人操作，请忽略此邮件信息。<br/><img src='cid:cool'/>", "text/html;charset=utf-8");
